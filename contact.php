...
<body>
    <header>
        ...
        <nav class="navbar navbar-light bg-light  navbar-expand-sm">
            ...
            <a href="#" class="btn btn-light">サンプル株式会社</a>
            ...
            <div class="col-sm-9">
                ...
                <form action="complete.php" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-form-labe col-sm-3">会社名：</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="offset-sm-3 col-sm-9">
                            ...
                            <button type="submit" class="btn btn-success col-xl-12">お問い合わせ内容を送信する</button>
                        </div>
                    </div>
                </form>
            </div>
